...
for(chrom in seq(1,22)){
	...
	path='/Volumes/gravel/luke_projects/1000Genomes/Regression/',
	pattern=paste("CHR",chrom,".Regression",sep=''), full.names = T)
	...
	write.table(paste('/Volumes/gravel/luke_projects/1000Genomes/MeanDev/Chromosome',chrom,'_MeanDev.csv',sep=''))
	Tot <- rbind(Tot,Reg)
}
