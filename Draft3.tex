...
\newcommand{\latcomment}[1]{\textcolor{blue}{LAT: #1}}
...
\afterpage{
\begin{figure}
\includegraphics[width=\hsize]{figures/MapQualOverTime.jpg}
...
\begin{figure}[]
\centering
\includegraphics[width=23cm,keepaspectratio, right]{figures/GWAS_Qual_GenomeWide_JPT.jpg}
...
\begin{figure}[h]
\centering
\includegraphics[width=\hsize,keepaspectratio, right]{figures/SNPOverlap6.jpg}
