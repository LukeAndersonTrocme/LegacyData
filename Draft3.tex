...
In investigating this mutational signature, we were unable to reproduce the results using a larger and higher quality dataset.


This study is the result of an investigation in the quality of the 1000 Genomes Project (1kGP) dataset.
To begin, we will discuss the discrepancy between the Japanese samples from the 1kGP and a more recent counterpart. 
We then consider methods to discriminate troublesome variants resulting from dated sequencing technologies. 
Furthermore, we explore more broadly how low quality variants have been propagated in the other populations included in the 1kGP.
...
To further investigate	 the extent to which low quality individuals were associated to spurious mutations, we then performed a genome-wide association study (GWAS) \ref{Figure2}.
