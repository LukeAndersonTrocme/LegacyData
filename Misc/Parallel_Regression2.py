...
def Bash_cmd(i):
    ...
    subprocess.call('for pop in CDX CLM IBS PEL PJL KHV ACB GWD ESN BEB MSL STU ITU CEU YRI CHB JPT LWK ASW; \
    do echo ${{pop}} {0}; \
    (ls /Users/luke/Documents/Regression/CHR{0}_NOT.Regression_${{pop}}.csv && echo "File Exists") \
    || Rscript /Users/luke/Documents/QualityPaper/Misc/JustStats.R \
    /Users/luke/Documents/Regression/CHR{0}_NOT.Format_${{pop}}.csv \
    /Users/luke/Documents/Regression/CHR{0}_NOT.Regression_${{pop}}.csv \
