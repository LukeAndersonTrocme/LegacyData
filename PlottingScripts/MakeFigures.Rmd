...
HanKgpAF <- readRDS(paste0(DataPath,
                   'HanKgpAF.rds'))
#Load joint frequency for Indels
INDEL <- readRDS(paste0(DataPath,
                   'INDEL_HanKgp.rds'))
...
ggplot(SNP, 
  ...
  labs(x = 'Resequenced Han', 
       y = '1000 Genomes Project') +
  ggtitle('Joint Frequency Plot of Suspicious SNPs')

ggsave('~/Documents/QualityPaper/Figures/Han_1kGP_SFS_SNP.jpg',height=10, width=10)
...
ggplot(INDEL, 
  ...
  labs(x='Resequenced Han', 
       y='1000 Genomes Project') +
  ggtitle('Joint Frequency Plot of Suspicious INDELS')

ggsave('~/Documents/QualityPaper/Figures/Han_1kGP_SFS_INDEL.jpg',height=10, width=10)
```
```{bash}
...
ggsave(paste0(figurePath,'OverUnder30.jpg'),height=5,width=10)
ggsave(paste0(figurePath,'OverUnder30.pdf'),height=5,width=10)
```
```{r}
sessionInfo()
```
