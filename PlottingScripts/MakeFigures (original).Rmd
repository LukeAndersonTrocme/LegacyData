...
SFS <- ggplot(join, aes(x = NAG_MAF, y = JPT_MAFALSE)) +
...
HIST <- ggplot(jj, aes(x = JPT_MAFALSE)) +
...
data$Rev <- ReverseComp(data$Context)
data$RevRef <- ReverseComp(data$ReFALSE)
data$RevAlt <- ReverseComp(data$Alt)
