...
\title{ {{L}}egacy Data Confounds Genomics Studies}

\author[Anderson-Trocm\'e et al.]{
{{L}}uke \surname{Anderson-Trocm\'e},$^{\ast,1,2}$ 
Rick Farouni,$^{1,2}$ 
Mathieu Bourgey,$^{1,2}$ 
Yoichiro Kamatani,$^{3}$ 
Koichiro Higasa,$^{3}$ 
...
$^{4}$Bioinformatics Institute, Macrogen Inc., Seoul, 08511, Republic of Korea\\ 
$^{5}$Precision Medicine Center, Seoul National University Bundang Hospital, Seongnam, 13605, Republic of Korea}


\history{Received 3 May 2019; reviews returned 27 May 2019}

\coresp{E-mail: simon.gravel@mcgill.ca}
...
\keyword{Batch Effect, Mutational Signature, Statistical Genetics, Population Genetics, Reference Cohorts, Imputation}
...
\bibliography{legacy_mbe}%%%Legacy.bib
