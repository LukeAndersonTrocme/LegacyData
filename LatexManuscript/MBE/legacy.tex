...
\begin{figure}
\scalebox{0.85}{\includegraphics[width=\hsize,keepaspectratio]{Figure1.jpg}}
\caption{
...
Thus, this mutational signal is heavily enriched in $Q$-associated SNPs, but residual signal remains in non-significant SNPs, presumably because many rare alleles found in individuals with low $Q$ remain unidentifiable using association techniques due to lack of power (Figure S2). %\ref{histogram_of_sig_snps}
The removal of individuals with $Q$ below 30 successfully removes the *AC${\rightarrow}$*CC signal enrichment in the Japanese, however other signals identified by Harris and Pritchard appear unchanged including the continental enrichment of *AC${\rightarrow}$*CC signal in East Asians compared to Africans as reported by Harris and Pritchard and replicated in the SGDP (Figure S3 and S4). %\ref{MutSpect} and \ref{MutSpect_continental}
...
Over 1,165 variants were independently associated to low $Q$ with $ p < 10^{-6}$ in each (Figure S6). %\ref{OverLap}
...
These models were broadly consistent (See Figure S7). %\ref{CompareModel}
...
%\ref{NRS_Manhattan},\ref{NRI_Manhattan}, \ref{RS_Manhattan}, and \ref{RI_Manhattan}
...
$Q$-associated variants are distributed across the genome, with chromosome 1 showing an excess of such variants, and other chromosomes being relatively uniform (Figure S12A). %\ref{CountPerChrom}
Chromosome 1 shows strong enrichments in the  *AC${\rightarrow}$*CC signal compared to other chromosomes despite normalizing for the number of variants tested per chromosome (Figure S12B). %\ref{CountPerChrom}
At a 1Mb scale, we also see rather uniform distribution with a small number of regions showing an enrichment for such variants (Figure S12C). %\ref{CountPerChrom}
Three outlying 1Mb regions in chromosomes 1, 2 and 17 have over 30 $Q$-associated variants.
Distribution of association statistics in these regions are provided in Figure S13. %\ref{Top10}.
By contrast, variants that do not pass the 1kGP strict mask are more unevenly distributed across the genome (Figure S12D). %\ref{CountPerChrom}
...
There is also an enrichment of mutations from TAC, TCT, and TGT to the homonucleotide TTT (Figure S14). %\ref{strict_gcat_mutational_enrichment}


A recent publication by Mafessoni et al. also identified a batch effect in the 1kGP using a method that uses linkage disequilibrium rather than quality metrics to identify 19,196 suspicious variants with 67\% of them passing the 1kGP strict mask \citep{mafessoni2018turning} (Figure S15A). %\ref{Mafessoni_MutSpect}
...
Among the 296 such variants that were $Q$-associated in single-population tests for the CHB or CHS, only 6 are present in the resequenced data (Figure S16). %\ref{90HanSFS}   
...
Of the 15,270 $Q$-associated variants identified globally, 6,307 are polymorphic in the 1kGP for the 83 resequenced individuals  (See Figure S17). %\ref{90HanSFS_full}
...
Finally, among the 15,270 $Q$-associated variants, 613 are present on Illumina's Omni 2.5 chip (See Figure S18). % \ref{Omni} 
...
These $Q$-associated variants could also compromise the imputation of nearby real-variants, however when considering the imputation scores of genotype data from Japanese individuals from Nagahama, there does not appear to be any impact on nearby variant imputation scores (Figure S19). % \ref{imputation_score}
...
By contrast, most $Q$-associated variants reported in the GWAS catalogue had weak bias (See Figure S21), with three exceptions. %\ref{Pub_30}
...
The variants identified in this study could be explained by technical artifacts from legacy technologies. %are likely to be
...
An enrichment in mutational profiles in one chromosome (Figure 12B) is difficult to explain through biological mechanisms or sequencing technology as neither are expected to produce systematic biases across chromosomes. %\ref{CountPerChrom}
...
\bibitem[{1000 Genomes Project Consortium},
  2010]{1000GenomesProjectConsortium2010}
{1000 Genomes Project Consortium} (2010).
\newblock {A map of human genome variation from population-scale sequencing.}
\newblock {\em Nature}, 467(7319):1061--73.

\bibitem[{1000 Genomes Project Consortium},
  2012]{The1000GenomesProjectConsortium2012}
{1000 Genomes Project Consortium} (2012).
\newblock {An integrated map of genetic variation}.
\newblock {\em Nature}, 135:0--9.

\bibitem[Aikens et~al., 2019]{Aikens2018}
Aikens, R.~C., Johnson, K.~E., and Voight, B.~F. (2019).
\newblock {Signals of Variation in Human Mutation Rate at Multiple Levels of
  Sequence Context}.
\newblock {\em Molecular Biology and Evolution}.

\bibitem[Alexandrov et~al., 2013]{Alexandrov2013}
...
\newblock {\em Nature}, 500(7463):415--421.

\bibitem[Astle et~al., 2016]{astle2016allelic}
...
\newblock {\em Cell}, 167(5):1415--1429.

\bibitem[Balding and Nichols, 1995]{balding1995method}
...
\newblock A method for quantifying differentiation between populations at
  ...
  paternity.
\newblock {\em Genetica}, 96(1-2):3--12.

\bibitem[Benjamini et~al., 2006]{Benjamini2006}
Benjamini, Y., Krieger, A.~M., and Yekutieli, D. (2006).
\newblock {Adaptive linear step-up procedures that control the false discovery
  rate}.
\newblock {\em Biometrika}.

\bibitem[Consortium et~al., 2015]{phase3}
Consortium, . G.~P. et~al. (2015).
\newblock A global reference for human genetic variation.
\newblock {\em Nature}, 526(7571):68.

\bibitem[Ebejer et~al., 2013]{Ebejer2013}
Ebejer, J.~L., Duffy, D.~L., {Van Der Werf}, J., Wright, M.~J., Montgomery, G.,
  Gillespie, N.~A., Hickie, I.~B., Martin, N.~G., and Medland, S.~E. (2013).
\newblock {Genome-wide association study of inattention and
  hyperactivity-impulsivity measured as quantitative traits}.
\newblock {\em Twin Research and Human Genetics}.

\bibitem[Ellinghaus et~al., 2016]{ellinghaus2016analysis}
...
\newblock {\em Nature genetics}, 48(5):510.

\bibitem[Gao et~al., 2018]{gao2018genome}
...
\newblock {\em Human molecular genetics}, 27(12):2205--2213.

\bibitem[Harris, 2015]{Harris2015a}
Harris, K. (2015).
\newblock {Evidence for recent, population-specific evolution of the human
  mutation rate}.
\newblock {\em Proceedings of the National Academy of Sciences},
  112(11):3439--3444.

\bibitem[Harris and Pritchard, 2017]{Harris2017a}
Harris, K. and Pritchard, J.~K. (2017).
\newblock {Rapid evolution of the human mutation spectrum}.
\newblock {\em eLife}, 6.

\bibitem[Herold et~al., 2016]{herold2016family}
...
\newblock Family-based association analyses of imputed genotypes reveal
  ...
  ptprg, and pdcl3.
\newblock {\em Molecular psychiatry}, 21(11):1608.

\bibitem[{International HapMap Consortium}, 2005]{HapMap2005}
{International HapMap Consortium} (2005).
\newblock {A haplotype map of the human genome.}
\newblock {\em Nature}, 437(7063):1299--320.

\bibitem[Kraja et~al., 2011]{Kraja2011}
...
\newblock {A bivariate genome-wide approach to metabolic syndrome: STAMPEED
  Consortium}.
\newblock {\em Diabetes}.

\bibitem[Lan et~al., 2017]{Lan2017}
...
\newblock {\em GigaScience}, 6(9):gix067.

\bibitem[Lek et~al., 2016]{Lek2016}
...
\newblock {\em Nature}, 536(7616):285--291.

\bibitem[L{\'o}pez-Mej{\'\i}as et~al., 2017]{lopez2017genome}
...
\newblock {\em Scientific reports}, 7(1):5088.

\bibitem[Lutz et~al., 2015]{lutz2015genome}
...
\newblock {\em BMC genetics}, 16(1):138.

\bibitem[Mafessoni et~al., 2018]{mafessoni2018turning}
...
\newblock {\em Genome biology and evolution}, 10(10):2697--2708.

\bibitem[Mallick et~al., 2016]{Mallick2016}
Mallick, S., Li, H., Lipson, M., Mathieson, I., Gymrek, M., Racimo, F., Zhao,
  ...
  Reich, D. (2016).
\newblock {The Simons Genome Diversity Project: 300 genomes from 142 diverse
  populations}.
\newblock {\em Nature}, 538(7624):201--206.

\bibitem[Mandage et~al., 2017]{Mandage2017}
Mandage, R., Telford, M., Rodr{\'{i}}guez, J.~A., Farr{\'{e}}, X., Layouni, H.,
  Marigorta, U.~M., Cundiff, C., Heredia-Genestar, J.~M., Navarro, A., and
  Santpere, G. (2017).
\newblock {Genetic factors affecting EBV copy number in lymphoblastoid cell
  lines derived from the 1000 Genome Project samples}.
\newblock {\em PLoS ONE}.

\bibitem[Mathieson and Reich, 2017]{Mathieson2017a}
Mathieson, I. and Reich, D. (2017).
\newblock {Differences in the rare variant spectrum among human populations}.
\newblock {\em PLoS Genetics}, 13(2).
...
\newblock {\em Nature genetics}, 48(10):1279.

\bibitem[Minoche et~al., 2011]{Minoche2011}
...
\newblock {\em Genome Biology}, 12(11).

\bibitem[Nagy et~al., 2017]{nagy2017exploration}
...
\newblock {\em Genome medicine}, 9(1):23.

\bibitem[Nishida et~al., 2018]{nishida2018key}
...
\newblock {\em Hepatology}, 68(3):848--858.

\bibitem[Park et~al., 2015]{park2015mercapturic}
...
\newblock {\em PLoS One}, 10(6):e0124841.

\bibitem[Pfeifer et~al., 2002]{Pfeifer2002}
Pfeifer, G.~P., Denissenko, M.~F., Olivier, M., Tretyakova, N., Hecht, S.~S.,
  and Hainaut, P. (2002).
\newblock {Tobacco smoke carcinogens, DNA damage and p53 mutations in
  smoking-associated cancers}.
\newblock {\em Oncogene}, 21-48(6):7435--7451.

\bibitem[Pleasance et~al., 2010]{Pleasance2010}
...
\newblock {A small-cell lung cancer genome with complex signatures of tobacco
  exposure}.
\newblock {\em Nature}, 463(7278):184--190.
...
\bibitem[Shiraishi et~al., 2015]{Shiraishi2015a}
Shiraishi, Y., Tremmel, G., Miyano, S., and Stephens, M. (2015).
\newblock {A Simple Model-Based Approach to Inferring and Visualizing Cancer
  Mutation Signatures}.
\newblock {\em PLoS Genetics}, 11(12).

\bibitem[Song et~al., 2015]{song2015testing}
Song, M., Hao, W., and Storey, J.~D. (2015).
\newblock Testing for genetic associations in arbitrarily structured
  populations.
\newblock {\em Nature genetics}, 47(5):550.

\bibitem[Spracklen et~al., 2017]{spracklen2017association}
...
\newblock {\em Human molecular genetics}, 26(9):1770--1784.

\bibitem[Suhre et~al., 2017]{suhre2017connecting}
...
\newblock Connecting genetic risk to disease end points through the human blood
  plasma proteome.
\newblock {\em Nature communications}, 8:14357.

\bibitem[Tian et~al., 2017]{tian2017genome}
...
\newblock {\em Nature communications}, 8(1):599.

\bibitem[van Dijk et~al., 2014]{VanDijk2014}
van Dijk, E.~L., Auger, H., Jaszczyszyn, Y., and Thermes, C. (2014).
\newblock {Ten years of next-generation sequencing technology}.
\newblock {\em Trends in Genetics}, 30(9):418--426.

\bibitem[Xu et~al., 2012]{xu2012genome}
...
\newblock {\em Nature genetics}, 44(11):1231.

\bibitem[Yucesoy et~al., 2015]{yucesoy2015genome}
...
\newblock {\em Toxicological Sciences}, 146(1):192--201.
