...
This method identifies a total of 24,390 variants associated to $Q$ distributed across the genome with 15,270 passing the 1kGP strict mask filter (Figures \ref{NRS_Manhattan},\ref{NRI_Manhattan}, \ref{RS_Manhattan}, and \ref{RI_Manhattan}). 
...
There are 9,124 $Q$-associated variants that are within the flagged regions of the 1kGP strict mask.
...
While regions flagged by the 1kGP strict mask appear enriched in $Q$-associated variants, we also identify a 10kb region in chromosome 17 has 35 $Q$-associated variants.
...
The allele frequencies of these variants are nearly identical between datasets suggesting that for these 83 individuals, these variants are properly genotyped in the 1kGP.
...
These variants are only removed after the FDR and excluded from downstream analyses.
