...
One study reports associations with seven $Q$-associated variants that we find to be highly biased \sgcomment{cite!}\cite{}. 
...
For the reverse GWAS, the only filtration used was the application of an minor and major allele frequency cutoff of 0.000599 (removing singletons, doubletons and tripletons) resulting in a total of S=28,516,063 variants included in the test \sgcomment{Explain why is this larger than the previous number?}. 
