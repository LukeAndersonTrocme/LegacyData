...
\luke{These mismatches were maintained despite} considering only sites that satisfied strict quality masks and Hardy-Weinberg equilibrium in both cohorts.
...
This method identifies a total of 15,270 variants associated to $Q$ distributed across the genome (Figures \ref{NRS_Manhattan},\ref{NRI_Manhattan}, \ref{RS_Manhattan}, and \ref{RI_Manhattan}). 
...
We apply the 1kGP strict mask after FDR-adjustments to allow the method to identify problematic regions already flagged as such.
...
Distribution of association statistics in the region with the most $Q$-associated variants is provided in Figure \ref{Top10}.
\luke{There are 9,124 $Q$-associated variants that are within the flagged regions of the 1kGP strict mask.}
...
Among the 296 variants associated with $Q$ within the 1kGP CHB and CHS, and polymorphic the 83 resequenced individuals, only 6 are present in the resequenced data (Figure \ref{90HanSFS}). 
...
From this subset, only 1,139 are present in the resequenced data.
...
\luke{We filtered out variants surpassing the significance threshold  flagged by the 1kGP strict mask after the FDR adjustment. }
...
One region in chromosome 17 has more than 10 variants per window.}  
