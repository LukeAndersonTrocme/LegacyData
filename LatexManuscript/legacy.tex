...
\caption{Results from the single population test. We find a total of 1,451 variants associated with the average quality of mapped bases $Q$ where 812 of them are found in at least one other population. Variants that pass the strict mask are in light grey while those that do not are in dark grey.
%Comparing results from the single population tests, we find 812 variants independently associated with average quality of mapped bases $Q$ in more than one population.
