...
Despite considering only sites that satisfied strict quality masks and Hardy-Weinberg equilibrium in both cohorts. \sgcomment{Something missing}
...
The majority (83.6\%) of the $Q$-associated variants are strongly biased in that they are more than twice as frequent in individuals with low-$Q$ compared to high-$Q$ data.
...
One study reports associations with seven $Q$-associated variants that we find to be highly biased \cite{}. 
