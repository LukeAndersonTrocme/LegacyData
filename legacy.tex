...
One of the top 25 SNPs in the GWAS on ADHD was identified as being significantly associated to data quality.
...
Four of the SNPs in the top hits of the Asian populations we're identified by our regression against data quality. 

The EBV strain was used to transform B-cells from blood samples from the 1kGP into lymphobastoid cell lines (LCLs).
