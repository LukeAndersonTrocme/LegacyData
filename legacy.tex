...
Subtle genome wide mutational signatures have been used as a diagnostic tool for cancers.
Distinct types of mutations that occur more frequently in certain cancers can be used to identify the cause and mechanisms of cancer [\cite].
Certain mutagens in tobacco smoke have been shown to preferentially bind to certain genomic motifs causing an excess of G to T transversions [\cite{}].
...
Taking advantage of large cohorts can increase statistical power to resolve some of these fine scale mutational signatures [\cite{}].
...
In 2015, Harris et al reported 50\% more TCC ${\rightarrow}$ TTC mutations in European populations compared to African populations.
