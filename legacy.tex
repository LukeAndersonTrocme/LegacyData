...
With the exception of chromosome 1 these variants appear to be evenly distributed across chromosomes (Figure \ref{CountPerChrom}).
Clusters of variants reaching significance are apparent in 10kb regions of the genome (Figure \ref{VariantDensity}).
These regions coincide with regions with known sequencing issues like HLA and other immunoglobulin receptor genes.
