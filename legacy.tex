...
The first sequenced genomes in the 1000 Genomes project (1kGP), for example, were sequenced \todo{10} years ago, at a time when sequencing technologies were still being . %\sgcomment{blah blah blah}. 
...
Mutations can occur in the genome as a result of environmental inflictions as well as variation in genetic factors like DNA proofreading and repair \cite{}.
...
In this paper, they proposed that not only is there a distinct mutational spectrum difference in Europeans, but that many populations have their own mutational signatures.
