...
The removal of individuals with average mapping quality below 30 successfully removes the *AC${\rightarrow}$*CC signal observed \sgcomment{How about the others?}.
...
There are 3990 variants that reach p values greater than $ p < 0.01$ after performing a two-stage Benjamini & Hochberg FDR adjustment. 
