...
To test whether quality is associated to genotype while adjusting for population structure, we performed the Genotype-Conditional Aassociation Test  (GCAT) proposed by \citep{song2015testing} The GCAT is a reverse regression approach that assumes the following model.
