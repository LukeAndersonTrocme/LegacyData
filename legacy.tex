...
One approach included the top five global principal components (PCs)as covariates to account for population structure without using a categorical variable.
Another combined both the population categorical variable as well as all five global PCs.  
...
Of the 11,416 suspicious variants identified globally, only 8,697 of them are found in the 83 individuals in the original 1kGP data.
